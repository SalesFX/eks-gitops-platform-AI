...
```
/docker-push-ecr devops-ia-apps/backend/YoutubeLiveApp 654654554686.dkr.ecr.us-east-1.amazonaws.com/devops-ia/production/backend:latest
```

```
/docker-push-ecr devops-ia-apps/backend/YoutubeLiveApp 654654554686.dkr.ecr.us-east-1.amazonaws.com/devops-ia/production/backend:v1.0.0, devops-ia-apps/frontend/youtube-live-app 654654554686.dkr.ecr.us-east-1.amazonaws.com/devops-ia/production/frontend:v1.0.0
```
...
- O projeto base fica em `/home/lustrabits/DevOps-Nuvem/aws-devops-platform/` — caminhos relativos sao resolvidos a partir dai
