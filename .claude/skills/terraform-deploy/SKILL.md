...
O projeto fica em `/home/lustrabits/DevOps-Nuvem/aws-devops-platform/`. As stacks são diretórios na raiz do projeto que:
- Contêm arquivos `*.tf`
...
```bash
ls -d /home/lustrabits/DevOps-Nuvem/aws-devops-platform/*/
```
